...
@section('page-title', 'Hired Candidates')
...
<div class="bg-white rounded-2xl shadow-xl overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-50 to-emerald-50">
        <div>
            <h2 class="text-lg font-semibold text-gray-800">Hired Candidates</h2>
            <p class="text-sm text-gray-600">Total: {{ count($candidates) }} hired</p>
        </div>
    </div>
                ...
                @forelse($candidates as $candidate)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500">
                            {{ $candidate->hired_at ? $candidate->hired_at->format('M d, Y') : 'N/A' }}
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Candidates will appear here after being marked as hired.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
